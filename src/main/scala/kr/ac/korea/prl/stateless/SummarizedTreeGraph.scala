...
object SummarizedTreeGraph {
  ...
  val summarizeCustomTree: CustomTree => String =
    (ctree: CustomTree) => ctree match {
      ...
      case current: TypeParam => current.productPrefix

      case current: TypeName => current.productPrefix
      ...
      case current: TermName => current.productPrefix
      ...
      case current: LitNull => "LitNull"

      case current: LitInt => current.productPrefix

      case current: LitDouble => current.productPrefix

      case current: LitFloat => current.productPrefix

      case current: LitByte => current.productPrefix

      case current: LitShort => current.productPrefix

      case current: LitChar => current.productPrefix

      case current: LitLong => current.productPrefix

      case current: LitBoolean => current.productPrefix

      case current: LitUnit => current.productPrefix

      case current: LitString => current.productPrefix

      case current: LitSymbol => current.productPrefix
      ...
      case current: CustomName => current.productPrefix
